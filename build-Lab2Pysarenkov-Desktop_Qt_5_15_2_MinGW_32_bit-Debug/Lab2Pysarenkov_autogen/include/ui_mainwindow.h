...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        menu_4->addAction(action4);
        menu_4->addAction(action5);
        menu_4->addAction(action6);
        menu_4->addAction(action7);
        menu_4->addAction(action8);
        menu_4->addAction(action9);
        menu_4->addAction(action10);
        menu_4->addAction(action11);
        menu_4->addAction(action12);
        menu_4->addAction(action13);
        menu_4->addAction(action14);
        menu_4->addAction(action15);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        action13->setText(QCoreApplication::translate("MainWindow", "13", nullptr));
        action14->setText(QCoreApplication::translate("MainWindow", "14", nullptr));
        action15->setText(QCoreApplication::translate("MainWindow", "15", nullptr));
#if QT_CONFIG(tooltip)
